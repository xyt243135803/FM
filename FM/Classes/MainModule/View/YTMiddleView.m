...
@implementation YTMiddleView

static YTMiddleView *_shareInstance;
+ (instancetype)shareInstance {
    if (_shareInstance == nil) {
        _shareInstance = [YTMiddleView middleView];
    }
    return _shareInstance;
}

+ (instancetype)middleView {
    YTMiddleView *middleView = [[[NSBundle mainBundle] loadNibNamed:@"YTMiddleView" owner:nil options:nil] firstObject];
    return middleView;
}
